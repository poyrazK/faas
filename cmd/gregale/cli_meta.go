...
var cliCommands = []cliCommand{
	...
	},
	{
		...
		Subcommands: []cliSub{
			...
			{Name: "setup", Short: "Bind GitHub, configure previews, and write an Actions workflow", Flags: []cliFlag{
				...
				{Name: "preview-environment-from", Short: "clone this project environment for same-repository PR previews", Value: "SLUG"},
				{Name: "no-preview-environment", Short: "disable durable project-environment PR previews"},
	...
	},
	{
		...
		Subcommands: []cliSub{
			...
			{Name: "environments", Short: "Manage project environments (list|create|protect|unprotect|releases|history|config [set]|routes set|policies [set|routing set|ip set]|diff|preview|promote|status|rollback); promote supports --wait [--progress] [--timeout SECONDS]"},
