...
var cliCommands = []cliCommand{
	...
	},
	{
		...
		Subcommands: []cliSub{
			...
			{Name: "regressions", Short: "Regressions (per-app/--all, watch, and confirmed rollback)"},
	...
	},
	{
		...
		Subcommands: []cliSub{
			...
			{Name: "environments", Short: "Manage project environments (list|create|protect|unprotect|preview|promote)"},
