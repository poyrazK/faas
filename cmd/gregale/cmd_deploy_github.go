...
//     CLI boundary).
//   - pinnedSHA: the immutable commit SHA for the moving major tag. Pass "" for
//     the "first release" case where the tag exists but the SHA pin
//     comment is omitted (the snippet still pins the moving major and the bundled
...
# App: %s · Repo: %s · Ref: %s
# Action: %s@%s
%s# For production safety, see https://gregale.dev/docs/deploy-from-github.
name: deploy
on:
  push:
    branches: [main]
