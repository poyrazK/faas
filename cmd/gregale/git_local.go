...
// path. It uses openCustomerFile so the preflight fingerprint keeps
// the same symlink and regular-file guarantees as the upload itself.
// Callers must compute the SHA before a generated tempfile is removed.
//
