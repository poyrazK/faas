...
func newMetricsMux(ops *wire.OpsMetrics, cbm *fcvm.ColdBootMetrics, frm *fcvm.FrameworkReadyMetrics, wpm *fcvm.WakePhaseMetrics) *http.ServeMux {
	mux := http.NewServeMux()
	mux.Handle(metricsPath, promhttp.HandlerFor(prometheus.Gatherers{
		ops.Registry(), cbm.Registry(), frm.Registry(), wpm.Registry(),
