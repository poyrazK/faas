...
const file_onebox_faas_githubd_v1_githubd_proto_rawDesc = "" +
	"\n" +
	"$onebox/faas/githubd/v1/githubd.proto\x12\x16onebox.faas.githubd.v1\"7\n" +
	...
	"\n" +
	"WriteCheck\x12).onebox.faas.githubd.v1.WriteCheckRequest\x1a*.onebox.faas.githubd.v1.WriteCheckResponseBHZFgithub.com/onebox-faas/faas/api/proto/onebox/faas/githubd/v1;githubdpbb\x06proto3"
...
var file_onebox_faas_githubd_v1_githubd_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_onebox_faas_githubd_v1_githubd_proto_goTypes = []any{
	...
	(*GetInstallStateRequest)(nil),           // 2: onebox.faas.githubd.v1.GetInstallStateRequest
	(*GetInstallStateResponse)(nil),          // 3: onebox.faas.githubd.v1.GetInstallStateResponse
	(*ExchangeOAuthCodeRequest)(nil),         // 4: onebox.faas.githubd.v1.ExchangeOAuthCodeRequest
	(*ExchangeOAuthCodeResponse)(nil),        // 5: onebox.faas.githubd.v1.ExchangeOAuthCodeResponse
	(*Repo)(nil),                             // 6: onebox.faas.githubd.v1.Repo
	(*ListInstallableReposRequest)(nil),      // 7: onebox.faas.githubd.v1.ListInstallableReposRequest
	(*ListInstallableReposResponse)(nil),     // 8: onebox.faas.githubd.v1.ListInstallableReposResponse
	(*BindAppRepoRequest)(nil),               // 9: onebox.faas.githubd.v1.BindAppRepoRequest
	(*BindAppRepoResponse)(nil),              // 10: onebox.faas.githubd.v1.BindAppRepoResponse
	(*UnbindAppRepoRequest)(nil),             // 11: onebox.faas.githubd.v1.UnbindAppRepoRequest
	(*UnbindAppRepoResponse)(nil),            // 12: onebox.faas.githubd.v1.UnbindAppRepoResponse
	(*GetAppBindingRequest)(nil),             // 13: onebox.faas.githubd.v1.GetAppBindingRequest
	(*GetAppBindingResponse)(nil),            // 14: onebox.faas.githubd.v1.GetAppBindingResponse
	(*CreateDeploymentFromPushRequest)(nil),  // 15: onebox.faas.githubd.v1.CreateDeploymentFromPushRequest
	(*CreateDeploymentFromPushResponse)(nil), // 16: onebox.faas.githubd.v1.CreateDeploymentFromPushResponse
	(*WriteCheckRequest)(nil),                // 17: onebox.faas.githubd.v1.WriteCheckRequest
	(*WriteCheckResponse)(nil),               // 18: onebox.faas.githubd.v1.WriteCheckResponse
}
var file_onebox_faas_githubd_v1_githubd_proto_depIdxs = []int32{
	...
	6,  // 1: onebox.faas.githubd.v1.ListInstallableReposResponse.repos:type_name -> onebox.faas.githubd.v1.Repo
	1,  // 2: onebox.faas.githubd.v1.WriteCheckRequest.phase:type_name -> onebox.faas.githubd.v1.CheckPhase
	2,  // 3: onebox.faas.githubd.v1.Githubd.GetInstallState:input_type -> onebox.faas.githubd.v1.GetInstallStateRequest
	4,  // 4: onebox.faas.githubd.v1.Githubd.ExchangeOAuthCode:input_type -> onebox.faas.githubd.v1.ExchangeOAuthCodeRequest
	7,  // 5: onebox.faas.githubd.v1.Githubd.ListInstallableRepos:input_type -> onebox.faas.githubd.v1.ListInstallableReposRequest
	9,  // 6: onebox.faas.githubd.v1.Githubd.BindAppRepo:input_type -> onebox.faas.githubd.v1.BindAppRepoRequest
	11, // 7: onebox.faas.githubd.v1.Githubd.UnbindAppRepo:input_type -> onebox.faas.githubd.v1.UnbindAppRepoRequest
	13, // 8: onebox.faas.githubd.v1.Githubd.GetAppBinding:input_type -> onebox.faas.githubd.v1.GetAppBindingRequest
	15, // 9: onebox.faas.githubd.v1.Githubd.CreateDeploymentFromPush:input_type -> onebox.faas.githubd.v1.CreateDeploymentFromPushRequest
	17, // 10: onebox.faas.githubd.v1.Githubd.WriteCheck:input_type -> onebox.faas.githubd.v1.WriteCheckRequest
	3,  // 11: onebox.faas.githubd.v1.Githubd.GetInstallState:output_type -> onebox.faas.githubd.v1.GetInstallStateResponse
	5,  // 12: onebox.faas.githubd.v1.Githubd.ExchangeOAuthCode:output_type -> onebox.faas.githubd.v1.ExchangeOAuthCodeResponse
	8,  // 13: onebox.faas.githubd.v1.Githubd.ListInstallableRepos:output_type -> onebox.faas.githubd.v1.ListInstallableReposResponse
	10, // 14: onebox.faas.githubd.v1.Githubd.BindAppRepo:output_type -> onebox.faas.githubd.v1.BindAppRepoResponse
	12, // 15: onebox.faas.githubd.v1.Githubd.UnbindAppRepo:output_type -> onebox.faas.githubd.v1.UnbindAppRepoResponse
	14, // 16: onebox.faas.githubd.v1.Githubd.GetAppBinding:output_type -> onebox.faas.githubd.v1.GetAppBindingResponse
	16, // 17: onebox.faas.githubd.v1.Githubd.CreateDeploymentFromPush:output_type -> onebox.faas.githubd.v1.CreateDeploymentFromPushResponse
	18, // 18: onebox.faas.githubd.v1.Githubd.WriteCheck:output_type -> onebox.faas.githubd.v1.WriteCheckResponse
