...
create table project_environment_cleanup_jobs (
...
create index project_environment_cleanup_jobs_due_idx
    on project_environment_cleanup_jobs (next_attempt_at, created_at, id)
    where lease_until is null;

create index project_environment_cleanup_jobs_lease_idx
