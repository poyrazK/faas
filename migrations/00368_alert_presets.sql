-- filename: 00368_alert_presets.sql
-- +goose Up
...
--     strings the evaluator learns in migration 00370; a future
--     metric lands here first, then in 00370, then in
...
-- in is migration 00369's idempotent seed.
--
...
-- table. The seed in 00369 is reversed by the table drop.
DROP TRIGGER IF EXISTS alert_presets_set_updated_at_trg ON alert_presets;
