-- filename: 00369_alert_presets_seed.sql
-- +goose Up
...
INSERT INTO alert_presets (
    ...
    (
        ...
        'Fires when any of the app''s domain certificates has fewer than 14 days remaining. Backed by the meterd_tenant_surface_cert_expiry refresher walker (migrations/00372).',
        'infrastructure',
