...
--                stamps this column. Length-bounded (64 hex chars, the
--                sha256 ceiling; a 40-char sha1 also fits) so a
--                pathological 1 MB string is rejected at the DB layer
...
ALTER TABLE deployments
    ADD CONSTRAINT deployments_commit_sha_len_chk
...
-- +goose StatementBegin
ALTER TABLE deployments
    DROP CONSTRAINT IF EXISTS deployments_commit_sha_len_chk;
ALTER TABLE deployments
