...
on the control plane so backup and restore verification remains wired when
the overlay is run independently. This separation keeps a Gregale host loss
from also deleting its incident logs:
