...
| API availability (5m) | `gateway_requests_total{app!="-",code=~"2.."}` / `gateway_requests_total{app!="-",code=~"2..|5.."}` × 100 | public SLO; excludes unresolved hosts and client/application 4xx outcomes |
