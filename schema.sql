...
CREATE TABLE public.apps (
    ...
    openapi_contract_policy text DEFAULT 'observe'::text NOT NULL,
    ...
    CONSTRAINT apps_openapi_contract_policy_chk CHECK ((openapi_contract_policy = ANY (ARRAY['observe'::text, 'warn'::text, 'block'::text]))),
