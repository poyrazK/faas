...
type ColdBootSpec struct {
	...
	// SkipReady suppresses readiness probing for builder and networkless
	// execution VMs. Builder guests run a finite build and power off; execution
	// guests use the vsock execution protocol instead of binding port 8080.
	SkipReady bool
