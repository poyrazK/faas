...
func StatusForCode(code string) int {
	...
	case CodeSourceInvalid, CodeBuildUndetected, CodeValidation, CodeCronInvalid,
		CodeAlertRuleInvalid, CodeAppWebhookInvalid, CodeAppLogDrainInvalid, CodeRealtimeInvalid, CodeLogArchiveInvalidQuery, CodeHandlerMissing, CodeImageRequired,
...
func ErrPlanRollbackOn5xxNotAllowed(p Plan) *Problem {
	return NewProblem(http.StatusForbidden, CodePlanRollbackOn5xxNotAllowed,
		...
		WithDocs(docsBase + "/plans#rollback-on-5xx")
}
