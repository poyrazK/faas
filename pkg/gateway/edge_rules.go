...
type HostEntry struct {
	...
	// Retry and CircuitBreaker carry the ADR-197 subsets. Same
...
// GetRetry returns the per-host kind=retry slice (ADR-197 §1). Mirrors
...
type EdgeRuleMatcher interface {
	...
	// MatchRetry and MatchCircuitBreaker are the ADR-197 matchers. Like
