...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_OBJECT_STORAGE_CONFIG", Owners: []string{"apid", "s3-gatewayd", "shared"}, Source: EnvSourceUnit, Note: "s3-gatewayd unit and opt-in apid drop-in use /etc/faas/object-storage.json; s3_enabled runtime config separately defaults off"},
