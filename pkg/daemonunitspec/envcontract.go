...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_FUNCTION_RUNNER_GO124", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
	{Name: "FAAS_FUNCTION_RUNNER_GO124_ALPINE", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
	{Name: "FAAS_FUNCTION_RUNNER_NODE22", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
	{Name: "FAAS_FUNCTION_RUNNER_NODE24", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
	{Name: "FAAS_FUNCTION_RUNNER_PYTHON312", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
	{Name: "FAAS_FUNCTION_RUNNER_PYTHON313", Owners: []string{"imaged", "shared"}, Source: EnvSourceUnit, Required: true, Validate: EnvValidationPathExists},
