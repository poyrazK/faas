...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_MANAGED_POSTGRES_QUALIFIED", Owners: []string{"shared"}, Source: EnvSourceDefault, Note: "explicit staging-only provider qualification approval; provisioning stays disabled unless true and the remaining qualification gates match"},
