...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_OCI_PASSWORD", Owners: []string{"shared"}, Source: EnvSourceEnvFile, Note: "read-only runtime credential in /etc/faas/storage.env; imaged lifecycle override in /etc/faas/imaged-storage.env"},
	...
	{Name: "FAAS_OCI_USERNAME", Owners: []string{"shared"}, Source: EnvSourceEnvFile, Note: "read-only runtime identity in /etc/faas/storage.env; imaged lifecycle override in /etc/faas/imaged-storage.env"},
