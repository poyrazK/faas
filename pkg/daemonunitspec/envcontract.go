...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_HOST_AGE_PREVIOUS_IDENTITY_PATH", Owners: []string{"s3-gatewayd"}, Source: EnvSourceDefault, Note: "optional systemd credential path during host-age rotation overlap"},
	...
	{Name: "FAAS_OBJECT_STORAGE_CONFIG", Owners: []string{"apid", "s3-gatewayd", "shared"}, Source: EnvSourceDefault, Note: "provider-registry JSON path; optional for apid but required by s3-gatewayd; s3_enabled runtime config separately defaults off (docs/object-storage.md)"},
	...
	{Name: "FAAS_S3_GATEWAY_CONTROL_ADDR", Owners: []string{"s3-gatewayd"}, Source: EnvSourceDefault, Default: "127.0.0.1:9096"},
	{Name: "FAAS_S3_GATEWAY_LISTEN_ADDR", Owners: []string{"s3-gatewayd"}, Source: EnvSourceDefault, Default: "127.0.0.1:8084"},
	{Name: "FAAS_S3_GATEWAY_ROLE", Owners: []string{"s3-gatewayd"}, Source: EnvSourceDefault, Default: "single-box", Note: "production control-plane service must set control-plane explicitly"},
	{Name: "FAAS_S3_GATEWAY_SPOOL_DIR", Owners: []string{"s3-gatewayd"}, Source: EnvSourceDefault, Note: "optional single-PUT staging directory; empty uses the OS temporary directory"},
