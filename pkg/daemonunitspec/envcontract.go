...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_CANARY_PROGRESSION_TOKEN", Owners: []string{"meterd"}, Source: EnvSourceSecretsEnv, Note: "delivered by /etc/faas/secrets/meterd/billing.env (meterd) and /etc/faas/sealed.env (apid)"},
	...
	{Name: "FAAS_SAFEDEPLOY_TOKEN", Owners: []string{"meterd"}, Source: EnvSourceSecretsEnv, Note: "delivered by /etc/faas/secrets/meterd/billing.env (meterd) and /etc/faas/sealed.env (apid)"},
	...
	{Name: "FAAS_STORAGE_CACHE_DIR", Owners: []string{"shared"}, Source: EnvSourceEnvFile},
