...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_RESTORE_PREFETCH", Owners: []string{"vmmd"}, Source: EnvSourceDefault, Note: "optional boolean kill switch for the ADR-226 restore working-set prefetch; production default is enabled"},
