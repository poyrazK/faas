...
var EnvContract = []EnvVar{
	...
	{Name: "FAAS_API_DISCOVERY_ENABLED", Owners: []string{"gatewayd-internal"}, Source: EnvSourceDefault, Note: "opt-in durable API route inventory; off by default pending operator path-privacy review (ADR-244)"},
