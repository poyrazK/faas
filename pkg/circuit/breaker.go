...
// instance breaker and schedd's egress breaker (ADR-195 §2, §3).
//
...
// DefaultConfig is the ADR-195 §2 default: open at a 50% failure ratio over a
...
// LegacyQuarantineConfig reproduces the pre-ADR-195 ServiceProxy behaviour: a
...
// EgressConfig is the ADR-195 §3 default for probe-driven breaking. The window
