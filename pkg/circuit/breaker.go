...
// instance breaker and schedd's egress breaker (ADR-197 §2, §3).
//
...
// DefaultConfig is the ADR-197 §2 default: open at a 50% failure ratio over a
...
// LegacyQuarantineConfig reproduces the pre-ADR-197 ServiceProxy behaviour: a
...
// EgressConfig is the ADR-197 §3 default for probe-driven breaking. The window
