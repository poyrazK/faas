...
// Per-kind edge-rule quotas for the ADR-197 traffic primitives.
//
...
//
// ADR-197 needs Free = 0 to genuinely mean "no retry rules", so these
...
// edgeRuleKindQuota returns the per-app quota for an ADR-197 kind, and
