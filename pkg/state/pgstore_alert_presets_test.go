...
// migration 00358 seed inserts the 8 catalog rows verbatim.
//
...
func TestPg_AlertPresetCatalog_ListOrdered(t *testing.T) {
	...
	// The PR-A seed (migrations/00358_alert_presets_seed.sql) ships
...
func TestPg_AlertPresetCatalog_ByName_And_NotFound(t *testing.T) {
	...
	// so the test is hermetic — it doesn't depend on 00358
