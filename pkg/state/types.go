...
const (
	...
	// schema CHECK constraint migrations/00362 widens to accept
	// this value.
...
const (
	...
	// The closed-set schema CHECK constraint migrations/00363
...
// deployments.cancel_reason (ADR-124, migration 00362). Mirrors
...
type Deployment struct {
	...
	// sooner). Range [0, 1000], default 100. Migration 00364
	...
	// column added in migration 00362. Nil for every other row.
