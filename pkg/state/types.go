...
// (migrations/00370_alert_rules_extend_metrics_chk.sql).
...
// account_spend_snapshot (issue #1233 / ADR-123 / migrations/00371).
...
// migrations/00372). The meterd cert-expiry refresher goroutine
