...
// (migrations/00354_alert_rules_extend_metrics_chk.sql).
...
// account_spend_snapshot (issue #1233 / ADR-123 / migrations/00355).
...
// migrations/00356). The meterd cert-expiry refresher goroutine
