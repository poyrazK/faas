...
func TestDurableNotificationChannelSet(t *testing.T) {
	for _, channel := range []string{NotifyAppWake, NotifyPrivateNetworkAttachmentChanged, NotifySnapshotPrime, NotifySnapshotBoot, NotifySnapshotWritten, NotifyDeploymentReady} {
