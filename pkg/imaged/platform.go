...
// that child to have an independent signature. Signature enforcement comes
// from apps.require_signed or security_policy=enforce. The stored customer
// reference remains intact while every subsequent app config/layer read uses
// childRef.
