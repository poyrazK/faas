...
func (p *gregaleProvider) Schema(_ context.Context, _ provider.SchemaRequest, resp *provider.SchemaResponse) {
	resp.Schema = providerschema.Schema{
		...
		Description:         "Manage Gregale applications and inspect project environments.",
		MarkdownDescription: "Manage Gregale applications and inspect project environments.",
	}
}
