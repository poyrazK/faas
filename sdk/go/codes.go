...
const (
	...
	CodeInvalidCPURAMPair              = api.CodeInvalidCPURAMPair
	...
	CodeUndeclaredRoute                = api.CodeUndeclaredRoute
	CodeDeclaredRoutePolicyUnavailable = api.CodeDeclaredRoutePolicyUnavailable
