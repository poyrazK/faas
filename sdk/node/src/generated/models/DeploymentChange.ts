...
export type DeploymentChange = {
  field: 'status' | 'kind' | 'build_id' | 'image_digest' | 'source_url' | 'commit_sha' | 'source_root' | 'scope' | 'build_plan' | 'min_instances' | 'traffic_percent' | 'has_overrides' | 'canary_preset' | 'rollout_state';
