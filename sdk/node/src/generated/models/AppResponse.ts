...
export type AppResponse = {
  ...
  /**
   * Target-side service allowlist of logical app slugs (ADR-239). Omitted means any same-account caller; an explicit empty array denies all. Project Compose owns this field.
   */
