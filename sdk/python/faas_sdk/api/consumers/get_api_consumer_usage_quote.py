...
from ...models.api_consumer_usage_quote_response import APIConsumerUsageQuoteResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/apps/{slug}/consumers/{consumer_id}/usage/quote".format(
...
) -> APIConsumerUsageQuoteResponse | Problem | None:
    if response.status_code == 200:
        response_200 = APIConsumerUsageQuoteResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[APIConsumerUsageQuoteResponse | Problem]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        APIConsumerUsageQuoteResponse | Problem
    """
