...
from ...models.send_app_message_request import SendAppMessageRequest
from ...models.send_app_message_response import SendAppMessageResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = SendAppMessageResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Problem | SendAppMessageResponse
    """
