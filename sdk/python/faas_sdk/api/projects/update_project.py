...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Problem | ProjectResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        slug (str):
        body (UpdateProjectRequest): Patch for the customer-managed repository binding and
            production branch.
