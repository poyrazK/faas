...
from ...models.create_preview_request import CreatePreviewRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/apps/{slug}/previews".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreatePreviewRequest): Pull-request preview provisioning payload. Source is deployed
            separately after the preview app is created.
