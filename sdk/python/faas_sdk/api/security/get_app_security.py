...
from ...models.app_security_posture_response import AppSecurityPostureResponse
...
) -> AppSecurityPostureResponse | Problem | None:
    if response.status_code == 200:
        response_200 = AppSecurityPostureResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppSecurityPostureResponse | Problem]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AppSecurityPostureResponse | Problem
    """
