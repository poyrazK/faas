...
def sync_detailed(
    ...
    *,
    ...
    """Abort a multipart upload and release provider-side parts
     ...
     Requires storage:write or admin and a matching bucket grant. Repeating an already-finished abort is
    safe. Failed aborts are retried by the recovery worker.
