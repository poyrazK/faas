...
) -> Problem | list[TCPListenerResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TCPListenerResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Problem | list[TCPListenerResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Problem | list[TCPListenerResponse]
    """
