...
from ...models.debug_critical_path_history_response import DebugCriticalPathHistoryResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/apps/{slug}/debug/critical-paths".format(
...
) -> DebugCriticalPathHistoryResponse | Problem | None:
    if response.status_code == 200:
        response_200 = DebugCriticalPathHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DebugCriticalPathHistoryResponse | Problem]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DebugCriticalPathHistoryResponse | Problem
    """
