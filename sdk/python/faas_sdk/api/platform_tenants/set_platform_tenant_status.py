...
from ...models.set_platform_tenant_status_request import SetPlatformTenantStatusRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body: SetPlatformTenantStatusRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (UUID):
        body (SetPlatformTenantStatusRequest): Suspend or resume linked credential and hostname
            paths.
