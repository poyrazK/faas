...
T = TypeVar("T", bound="PlatformTenantCredentialMetadata")


@_attrs_define
class PlatformTenantCredentialMetadata:
    """Metadata for a linked consumer key; plaintext and hash are excluded. ID and creation time are omitted for planned
    keys in a dry run.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        platform_tenant_credential_metadata = cls(
            consumer_id=consumer_id,
            name=name,
            prefix=prefix,
            scopes=scopes,
        ...
        platform_tenant_credential_metadata.additional_properties = d
        return platform_tenant_credential_metadata
