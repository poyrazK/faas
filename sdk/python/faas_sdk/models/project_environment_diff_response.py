...
if TYPE_CHECKING:
    ...
    from ..models.project_environment_workload_diff_response import ProjectEnvironmentWorkloadDiffResponse


T = TypeVar("T", bound="ProjectEnvironmentDiffResponse")


@_attrs_define
class ProjectEnvironmentDiffResponse:
    ...
    workloads: list[ProjectEnvironmentWorkloadDiffResponse]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        configuration = ProjectEnvironmentConfigDiffResponse.from_dict(d.pop("configuration"))

        workloads = []
        _workloads = d.pop("workloads")
        for workloads_item_data in _workloads:
            workloads_item = ProjectEnvironmentWorkloadDiffResponse.from_dict(workloads_item_data)
        ...
        project_environment_diff_response = cls(
            project_slug=project_slug,
            from_environment=from_environment,
            to_environment=to_environment,
            configuration=configuration,
        ...
        project_environment_diff_response.additional_properties = d
        return project_environment_diff_response
