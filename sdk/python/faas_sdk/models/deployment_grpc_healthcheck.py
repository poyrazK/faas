...
T = TypeVar("T", bound="DeploymentGRPCHealthcheck")


@_attrs_define
class DeploymentGRPCHealthcheck:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deployment_grpc_healthcheck = cls(
            service=service,
        )

        deployment_grpc_healthcheck.additional_properties = d
        return deployment_grpc_healthcheck
