...
T = TypeVar("T", bound="PlatformTenantListResponse")


@_attrs_define
class PlatformTenantListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for tenants_item_data in _tenants:
            tenants_item = PlatformTenantResponse.from_dict(tenants_item_data)
        ...
        return platform_tenant_list_response
