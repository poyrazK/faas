...
from ..models.platform_tenant_statement_summary_response_status import (
    PlatformTenantStatementSummaryResponseStatus,
    check_platform_tenant_statement_summary_response_status,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlatformTenantStatementSummaryResponse")


@_attrs_define
class PlatformTenantStatementSummaryResponse:
    """Finalized statement metadata without the potentially large line-item collection; retrieve line items by statement
    ID.
    ...
    revision: int
    status: PlatformTenantStatementSummaryResponseStatus
    billable_units: int
    unpriced_units: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = check_platform_tenant_statement_summary_response_status(d.pop("status"))
        ...
        platform_tenant_statement_summary_response = cls(
            id=id,
            tenant_id=tenant_id,
            period_start=period_start,
            period_end=period_end,
        ...
        platform_tenant_statement_summary_response.additional_properties = d
        return platform_tenant_statement_summary_response
