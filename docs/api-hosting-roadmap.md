...
| Platform snapshot wake | p95 < 350 ms | capacity admission/`wake.boot_started` to first upstream byte on the reference SSD node; excludes CDN, Internet, remaining app response, and client distance |
