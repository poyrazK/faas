...
| [Request retry](../docs/adr/201-traffic-as-a-platform-primitive) | edge | `internal` | — | Replay a request that died in transport against a different healthy instance of the same app. | `pkg/gateway/handler_retry_test.go::TestHandlerRetryConvertsTransportFailureIntoSuccess` |
