...
- **Status:** accepted v1.1 (2026-07-29). Shipped via PRs #112, #113, #114, #115, #119, #122; the placeholder `host_ip:8080` is gone, `WakeResponse.node_id` is on the wire, and gatewayd's `NodeClientCache` evicts on `compute_node_changed`. v1.1 cross-references ADR-025 v1.1 and ADR-029 v1.1 — the three-axis story now reads as a unit.
