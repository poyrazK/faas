...
still need retention/reconciliation. Export retention, full log delivery,
incremental caching, CI/release gates, and release-tag ordering remain separate
follow-ups to the build pipeline audit.
