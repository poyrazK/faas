...
| 268 | [Bounded API route inventory independent of request audit](268-bounded-independent-api-route-inventory.md) | accepted for initial implementation | Durable, replay-safe 500-route inventory with separate opt-in and audit-independent read API |
...
| 250 | [Per-runtime secret reload observations](250-per-runtime-secret-reload-observations.md) | accepted | Fleet status is tracked per active runtime without implying the app applied newly projected credentials |
