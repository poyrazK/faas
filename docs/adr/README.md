...
| 261 | [Per-runtime secret reload observations](261-per-runtime-secret-reload-observations.md) | accepted | Fleet status is tracked per active runtime without implying the app applied newly projected credentials |
