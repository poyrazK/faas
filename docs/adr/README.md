...
| 209 | [Application companions without exposing an orchestration API](209-application-companions.md) | accepted | Preferred companion API, managed presets, task-local shared memory, and rollout-safe primary ingress |
