...
| 208 | [Application companions without exposing an orchestration API](208-application-companions.md) | accepted | Preferred companion API, managed presets, task-local shared memory, and rollout-safe primary ingress |
