...
|---|---|---|---|
| 270 | [Binding-scoped private service aliases](270-binding-scoped-internal-aliases.md) | accepted | Declared bindings gain private `<service>.internal:10080` names without claiming unbound customer DNS or bypassing proxy authorization |
