...
|---|---|---|---|
| 212 | [Preview-scoped internal service resolution](212-preview-scoped-internal-service-resolution.md) | accepted | Same-account/project/PR workload lookup before the policy-controlled production fallback |
