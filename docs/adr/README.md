...
| 244 | [Bounded API route inventory independent of request audit](244-bounded-independent-api-route-inventory.md) | accepted for initial implementation | Durable, replay-safe 500-route inventory with separate opt-in and audit-independent read API |
